...
class TestDatabase(unittest.TestCase):
    ...
    def test_crear_cliente(self):
        nuevo_cliente = db.Clientes.crear('39X','Fernando','Blanco')
        self.assertEqual(len(db.Clientes.lista),4)
        self.assertEqual(nuevo_cliente.dni,'39X')
        self.assertEqual(nuevo_cliente.nombre,'Fernando')
        self.assertEqual(nuevo_cliente.apellido,'Blanco')
    ...
    def test_dni_valido(self):
        ...
        self.assertFalse(helpers.dni_valido('2222S',db.Clientes.lista))
